...
const options = {
  ...
  onClose(selectedDates) {   // Метод onClose() з об'єкта параметрів викликається щоразу під час закриття елемента інтерфейсу, який створює flatpickr.
...
startButton.addEventListener("click", ()=> {
   if (userSelectedDate) startTimer(); 
});
